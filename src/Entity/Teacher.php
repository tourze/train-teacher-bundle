...
#[ORM\Table(name: 'train_teacher', options: ['comment' => '表描述'])]
...
#[ORM\Column(type: Types::STRING, length: 36, options: ['comment' => '字段说明'])]
     ...
     * 教师编号
     */
#[ORM\Column(name: 'teacher_code', type: Types::STRING, length: 32, unique: true, options: ['comment' => '字段说明'])]
    private string $teacherCode;

    /**
     * 教师姓名
     */
#[ORM\Column(name: 'teacher_name', type: Types::STRING, length: 50, options: ['comment' => '字段说明'])]
    private string $teacherName;

    /**
     * 教师类型（专职、兼职）
     */
#[ORM\Column(name: 'teacher_type', type: Types::STRING, length: 20, options: ['comment' => '字段说明'])]
    private string $teacherType;

    /**
     * 性别
     */
#[ORM\Column(type: Types::STRING, length: 10, options: ['comment' => '字段说明'])]
    private string $gender;

    /**
     * 出生日期
     */
#[ORM\Column(name: 'birth_date', type: Types::DATE_MUTABLE, options: ['comment' => '字段说明'])]
    private \DateTimeInterface $birthDate;

    /**
     * 身份证号
     */
#[ORM\Column(name: 'id_card', type: Types::STRING, length: 18, options: ['comment' => '字段说明'])]
...
#[ORM\Column(type: Types::STRING, length: 100, options: ['comment' => '字段说明'])]
     ...
     * 毕业院校
     */
#[ORM\Column(name: 'graduate_school', type: Types::STRING, length: 100, options: ['comment' => '字段说明'])]
    private string $graduateSchool;

    /**
     * 毕业日期
     */
#[ORM\Column(name: 'graduate_date', type: Types::DATE_MUTABLE, options: ['comment' => '字段说明'])]
    private \DateTimeInterface $graduateDate;

    /**
     * 工作经验（年）
     */
#[ORM\Column(name: 'work_experience', type: Types::INTEGER, options: ['comment' => '字段说明'])]
...
#[ORM\Column(type: Types::JSON, options: ['comment' => '字段说明'])]
     ...
     * 教师状态
     */
#[ORM\Column(name: 'teacher_status', type: Types::STRING, length: 20, options: ['comment' => '字段说明'])]
    private string $teacherStatus;

    /**
     * 头像
     */
#[ORM\Column(name: 'profile_photo', type: Types::STRING, length: 255, nullable: true, options: ['comment' => '字段说明'])]
    private ?string $profilePhoto = null;

    /**
     * 入职日期
     */
#[ORM\Column(name: 'join_date', type: Types::DATE_MUTABLE, options: ['comment' => '字段说明'])]
...
#[ORM\Column(name: 'create_time', type: Types::DATETIME_IMMUTABLE, options: ['comment' => '字段说明'])]
     ...
     * 更新时间
     */
#[ORM\Column(name: 'update_time', type: Types::DATETIME_IMMUTABLE, options: ['comment' => '字段说明'])]
