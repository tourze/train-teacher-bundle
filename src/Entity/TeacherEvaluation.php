...
#[ORM\Table(name: 'train_teacher_evaluation')]
...
class TeacherEvaluation
{
     ...
     * 评价者类型（学员、同行、管理层、自我）
     */
    #[ORM\Column(name: 'evaluator_type', type: Types::STRING, length: 20)]
    private string $evaluatorType;

    /**
     * 评价者ID
     */
    #[ORM\Column(name: 'evaluator_id', type: Types::STRING, length: 36)]
    private string $evaluatorId;

    /**
     * 评价类型
     */
    #[ORM\Column(name: 'evaluation_type', type: Types::STRING, length: 50)]
    private string $evaluationType;

    /**
     * 评价日期
     */
    #[ORM\Column(name: 'evaluation_date', type: Types::DATE_MUTABLE)]
    private \DateTimeInterface $evaluationDate;

    /**
     * 评价项目
     */
    #[ORM\Column(name: 'evaluation_items', type: Types::JSON)]
    private array $evaluationItems = [];

    /**
     * 评价分数
     */
    #[ORM\Column(name: 'evaluation_scores', type: Types::JSON)]
    private array $evaluationScores = [];

    /**
     * 总体评分
     */
    #[ORM\Column(name: 'overall_score', type: Types::DECIMAL, precision: 3, scale: 1)]
     ...
     * 评价状态
     */
    #[ORM\Column(name: 'evaluation_status', type: Types::STRING, length: 20)]
